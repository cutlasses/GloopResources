...
The code for this test is here https://github.com/cutlasses/GloopTest, it should give a good starting point for writing your own replacement firmware for Gloop as it exposes a the hardware pin configuration.
